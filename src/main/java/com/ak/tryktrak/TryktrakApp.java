...
public class TryktrakApp extends Application {
    ...
    private Frame[][] plane = new Frame[WIDTH][HEIGHT];
    ...
    private Parent createContent(){
        ...
        root.getChildren().addAll(tileGroup, pieceGroup, frameGroup);

        int y;
        int x = 0;
        // creating bord of tiles
        // left top
        ...
        for (y=0; y<HEIGHT; y++){
            for (x=6; x<8; x++){
                ...
                frameGroup.getChildren().add(frame);
                plane[x][y] = frame;
